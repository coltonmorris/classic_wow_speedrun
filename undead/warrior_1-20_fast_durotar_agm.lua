...
<< Horde
#version 11
#group colton 1-20 |T136187:0|t |T626008:0|t 
#defaultfor Undead 
#name fast_durotar 1-20 Tirisfal Glades

step
#completewith lvl2
>>|cRXP_WARN_Make sure you preset an earth root in the vendor.|r
...
step
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Zansoa|r
    .vendor >> Vendor trash
    .target Zansoa
...
>>For the boat to reach the same spot, but from the different direction, it takes 3 minutes 15 seconds
>>Fatigue takes 1 minute to start killing you, you can use a health pot to delay death
>>If at waiting spot, it takes 26 seconds. The two timers to start swimming are at: 2 mintues 43 seconds, and 5 mintues 20 seconds
>>If at the shoreline, it takes 1 mintue 30 seconds. The two timers to start swimming are at: 1 minute 40 seconds, and 4 minutes 20 seconds
...
step
    .goto Orgrimmar,55.9,72.9
    .vendor >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Sana|r buy current upgrades, and also chainmail armor set with the wall shield
    >> TODO we should probably just automate this whole step. i dont think its really possible to have gear that is better than these
    .target Sana
...
#completewith next
    ...
    >>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTODO keep in mind setting hearth stone to org can open up batching possibilites with a ghetto hearth|r
    .zoneskip Durotar
...
step
    ...
    .goto Tirisfal Glades,38.1,47.1,20,0
    ...
    >>Craft all of your |T135232:0|t[Rough Stones] into |T135248:0|t[Rough Sharpening Stones] and then craft |T133685:0|t[Linen Bandages] while traveling
    >>You will jump off the zeplin to begin the Scarlet Warrior masacre 
    .zoneskip Tirisfal Glades

step
#completewith warrior
...
step
.goto Tirisfal Glades,52.81,26.36
.zone Tirisfal Glades >>Log out, then use the "Stuck Character Service" on battle.net 
...
.goto Tirisfal Glades,61.03,52.35
>>|Tinterface/worldmap/chatbubble_64grey.blp:20|tTalk to |cRXP_FRIENDLY_Abigail|r
>>|cRXP_BUY_Buy a|r |T132891:0|t[Coarse Thread]|cRXP_BUY_, 15|r 
...
step
.hs >> Hearthstone BATCH to Razor Hill
.target Innkeeper Renee
.use 6948
